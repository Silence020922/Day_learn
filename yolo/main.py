...
if __name__ == '__main__':
    ...
    # 初始化2个撞线polygon
    list_pts_blue = [[25, 66], [926, 308], [983, 344], [20, 116]]
    
    #[[204, 305], [227, 431], [605, 522], [1101, 464], [1900, 601], [1902, 495], [1125, 379], [604, 437],
    #                 [299, 375], [267, 289]]
    ...
    # 填充第二个polygon
    mask_image_temp = np.zeros((720, 1280), dtype=np.uint8)
    list_pts_yellow = [[20, 116], [983, 344], [1030, 370], [15, 146]]
    
    #[[181, 305], [207, 442], [603, 544], [1107, 485], [1898, 625], [1893, 701], [1101, 568],
